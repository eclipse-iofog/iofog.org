...
> You can use the `hostNetworkMode` and  `isPrivileged` of the [microservice yaml definition](../yaml-references/reference-application.html) to grant root access to the host to your container
...
<aside class="notifications contribute">
  ...
  <a href="https://github.com/eclipse-iofog/iofog.org/edit/develop/content/docs/3.7/reference-microservices-catalog/rest-blue.md"
    target="_blank">
