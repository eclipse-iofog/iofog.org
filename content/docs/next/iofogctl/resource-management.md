...
Specifications of the ioFog platform YAML types can be found [here](../yaml-references/reference-control-plane.html).

Specifications of the ioFog application YAML types can be found [here](../yaml-references/reference-application.html).
...
<aside class="notifications note">
  <h3><img src="/images/icos/ico-note.svg" alt=""> Next steps?</h3>
    <ul>
      <li><a href="../iofogctl/connect-disconnect.html">Connecting to an existing ECN.</a></li>
...
<aside class="notifications contribute">
  ...
  <a href="https://github.com/eclipse-iofog/iofog.org/edit/develop/content/docs/3.7/iofogctl/resource-management.md"
    target="_blank">
