...
<aside class="notifications danger">
  <h3><img src="/images/icos/ico-danger.svg" alt=""> Make sure your remote hosts are ready for Agent installation via iofogctl!</h3>
  <p>Go to <a href="../platform-deployment/prepare-your-remote-hosts.html">Prepare your Remote Hosts</a> to find out how to prepare your Agent hosts for installation.</p>
</aside>
...
Check out the [YAML specification](../yaml-references/reference-agent/) to get started!
...
<aside class="notifications contribute">
  ...
  <a href="https://github.com/eclipse-iofog/iofog.org/edit/develop/content/docs/3.7/platform-deployment/setup-your-agents.md"
    target="_blank">
