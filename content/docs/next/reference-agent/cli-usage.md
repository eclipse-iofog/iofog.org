...
| [cert](#cert)               | Base64 encoded string. Set the controller CA certificate for secure communication. |
...
| **-gpsd string**   | Set the GPS device to use (example: /dev/ttyUSB0) |
| **-gpsf seconds**   | Set the GPS scan frequency |
| **-egf seconds**   |  Set the edge guard frequency |
| **-pf hours**   |  Set container image pruning frequency in hours |
...
```sh
iofog-agent cert $Controller CA cert in base64 encoded string
```
...
<aside class="notifications contribute">
  ...
  <a href="https://github.com/eclipse-iofog/iofog.org/edit/develop/content/docs/3.7/reference-agent/cli-usage.md"
    target="_blank">
