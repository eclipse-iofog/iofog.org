...
`iofogctl` allows users to manage a Controller's list of catalog items. To learn more about catalog items, please see [microservice catalog documentation](../applications/microservice-registry-catalog.html).
...
<aside class="notifications contribute">
  ...
  <a href="https://github.com/eclipse-iofog/iofog.org/edit/develop/content/docs/3.0/reference-iofogctl/reference-catalog.md"
    target="_blank">
